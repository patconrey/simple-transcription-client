...
import { markSessionAsBegun } from '../services/recordingSessions'
...
export default function Home() {
	...
	useEffect(() => {
		const sessionIdFromUrl = new URLSearchParams(search).get('sessionId')
		if (sessionIdFromUrl) {
			markSessionAsBegun(sessionIdFromUrl)
				.then(data => {
					if (data.error) {
						return;
					}
